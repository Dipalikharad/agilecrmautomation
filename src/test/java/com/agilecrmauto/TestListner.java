...
public void onStart(ISuite suite) {
	System.out.println("This is  onstart methodof suite");
...
public void onFinish(iSuite suite) {
	System.out.println("this is on finish method of suite " );
	driver.quit();
	extentReport.flush();
}
...
public  void  onFinish(ITestContext context) {
	System.out.println("This ison test finish");
}
	
public void  onTestStart(ITestResult result) {
System.out.println("Thisis test result mtd");	
...
public void onTestSuccess(ITestResult result) {
	...
	System.out.println("on TestSuccess mtd");
}
...
String outputPath=System.getProperty("user.dir")+"//ExecutionResult//Screenshot//" + fileName + ".png";
